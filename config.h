...
//static char *font = "Ac437 IBM BIOS:pixelsize=14:antialias=true:autohint=true";
//static char *font2[] = { "Ac437 IBM BIOS:pixelsize=10:antialias=true:autohint=true" };

static char *font = "iosevka-term:pixelsize=14:antialias=true:autohint=true";
static char *font2[] = { "iosevka:pixelsize=10:antialias=true:autohint=true" };
